...
class kernel(object):
    ...
    def __init__(self,stat=0, jd=0,rvs=0,rv_err=0,o_c=0, model=0,model_jd=0,npl=0,a=0,mass=0,idset=0,stat_array_saved=0,reduced_chi2=0,chi2=0,rms=0,loglik=0,mfit=0, omega_dot=0,omega_dot_err=0):
        self.stat = stat
