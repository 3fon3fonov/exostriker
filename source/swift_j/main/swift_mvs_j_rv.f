...
c  be integrated.
c
c  It also outputs the star's barycentric velocity into rv.out.
c
...
c Last revision: 
	...
	integer iflgchk,iub,iuj,iud,iue,iur
...
c...    Do the initial io write
      open (unit=iur,file='rv.out',status='new')
c     Use the variables xh, vxh, ... to store xb, vxb, ...
      call coord_j2b(nbod,mass,xj,yj,zj,vxj,vyj,vzj,xh,yh,zh,
     &               vxh,vyh,vzh)
      write (iur,997) t,vxh(1),vyh(1),vzh(1)
 997  format (1x,1p4e18.8)
