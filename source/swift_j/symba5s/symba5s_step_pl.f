...
c Last revision: 7/18/06 MHL
      ...
      subroutine symba5s_step_pl(i1st,time,nbod,nbodm,mass,j2rp2,
...
c...  check for encounters
      ...
      do j=2,nbodm
         do i=j+1,nbod
            ...
            call symba5_chk(rhill,nbod,i,j,mass,xr,yr,zr,vxr,
     &           vyr,vzr,dt,irec,ieflg,svdotr)
