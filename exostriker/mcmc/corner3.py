...
def corner(xs, bins=20, range=None, weights=None, color="k",
    ...
    **hist2d_kwargs
    ...
    lbdim = 0.63 * factor   # size of left/bottom margin
    ...
    for i, x in enumerate(xs):
        ...
        if i < K - 1:
            ...
            if labels is not None:
                ...
                ax.xaxis.set_label_coords(0.5, -0.38)
        ...
        for j, y in enumerate(xs):
            ...
            if j > 0:
                ...
                [l.set_rotation(35) for l in ax.get_yticklabels()]
                if labels is not None:
...
def hist2d(x, y, bins=20, range=None, weights=None, levels=None, smooth=None,
    ...
    if plot_datapoints:
        ...
        ax.plot(x, y, "o",  rasterized=True, **data_kwargs)
