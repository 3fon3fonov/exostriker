...
class ActivityWindow(QtWidgets.QWidget, Ui_ActivityWindow):
    def __init__(self,parent):
        ...
        Ui_ActivityWindow.__init__(self)
    ...
    def init_data(self):
        ...
        self.data_file_name = self.parent.act_data[-1]
    ...
    def sigma_clip_func(self):
        ...
        self.ui.try_button.setText("Working!!!")
        t_, flux_, flux_err_, ind = rv.sigma_clip_act(self.t,self.flux,self.flux_err, np.zeros(len(self.t)), sigma_clip =self.ui.act_sigma_clip.value())         
        self.ui.try_button.setText("Try !")
...
#                break_tolerance=self.ui.spline_bt.value(),  # Split into segments at breaks longer than that
    ...
    def closeEvent(self, event):
        ...
        if len(self.old_t)  != len(self.t):
            ...
            if ret == QtGui.QMessageBox.Yes:
                ...
                self.flux_err_store[self.parent.act_data_index]      = self.flux_err
                self.flux_o_c_store[self.parent.act_data_index]      = self.flux_o_c
                self.flux_err_o_c_store[self.parent.act_data_index]  = self.flux_err_o_c
    ...
    def save_data_product(self):
        ...
        if str(output_file[0]) != '':
            ...
            f.write("# BJD     Activity data    Activity data errors,   Original data   Original data errors    Model applied \n")
