...
# Set auto formatting flags individually
        ...
        open_file_action = QAction(QIcon(os.path.join('./lib/word_processor_es/images', 'blue-folder-open-document.png')), "Open file...", self)
        open_file_action.setStatusTip("Open file")
        open_file_action.triggered.connect(self.file_open)
        file_menu.addAction(open_file_action)
        file_toolbar.addAction(open_file_action)

        save_file_action = QAction(QIcon(os.path.join('./lib/word_processor_es/images', 'disk.png')), "Save", self)
        save_file_action.setStatusTip("Save current page")
        save_file_action.triggered.connect(self.file_save)
        file_menu.addAction(save_file_action)
        file_toolbar.addAction(save_file_action)

        saveas_file_action = QAction(QIcon(os.path.join('./lib/word_processor_es/images', 'disk--pencil.png')), "Save As...", self)
        saveas_file_action.setStatusTip("Save current page to specified file")
        saveas_file_action.triggered.connect(self.file_saveas)
        file_menu.addAction(saveas_file_action)
        file_toolbar.addAction(saveas_file_action)

        #print_action = QAction(QIcon(os.path.join('./lib/word_processor_es/images', 'printer.png')), "Print...", self)
       ...
       # file_toolbar.addAction(print_action)
        ...
        undo_action = QAction(QIcon(os.path.join('./lib/word_processor_es/images', 'arrow-curve-180-left.png')), "Undo", self)
        undo_action.setStatusTip("Undo last change")
        undo_action.triggered.connect(self.editor.undo)
        edit_menu.addAction(undo_action)

        redo_action = QAction(QIcon(os.path.join('./lib/word_processor_es/images', 'arrow-curve.png')), "Redo", self)
        ...
        wrap_action = QAction(QIcon(os.path.join('./lib/word_processor_es/images', 'arrow-continue.png')), "Wrap text to window", self)
