...
class Ui_Detrend(object):
    def setupUi(self, Detrend):
        ...
        self.gridLayout.addWidget(self.radio_Regressions, 7, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.line_2, 2, 6, 7, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_GP, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.Dilution_fact, 8, 7, 1, 2)
        ...
        self.gridLayout.addWidget(self.readme_button, 8, 10, 1, 1)
        ...
        self.gridLayout.addWidget(self.kernel_size, 8, 3, 1, 1)
        self.line = QtWidgets.QFrame(Detrend)
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.gridLayout.addWidget(self.line, 2, 9, 8, 1)
        ...
        self.gridLayout.addWidget(self.regres_wl, 7, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.radio_GPs, 8, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.regres_bt, 7, 4, 1, 1)
        ...
        self.extra_BJD.setMinimum(-9999999999999.0)
        self.extra_BJD.setMaximum(9999999999999.0)
        self.extra_BJD.setProperty("value", 2457000.0)
        self.extra_BJD.setObjectName("extra_BJD")
        self.gridLayout.addWidget(self.extra_BJD, 6, 7, 1, 2)
