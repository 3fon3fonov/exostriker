...
class Ui_Detrend(object):
    def setupUi(self, Detrend):
        ...
        self.gridLayout.addWidget(self.extra_BJD, 7, 8, 1, 1)
        self.add_epoch = QtWidgets.QPushButton(Detrend)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.add_epoch.setFont(font)
        self.add_epoch.setObjectName("add_epoch")
        self.gridLayout.addWidget(self.add_epoch, 7, 7, 1, 1)
        self.checkBox = QtWidgets.QCheckBox(Detrend)
        self.checkBox.setEnabled(False)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.checkBox.setFont(font)
        self.checkBox.setObjectName("checkBox")
        self.gridLayout.addWidget(self.checkBox, 6, 7, 1, 1)
        self.doubleSpinBox = QtWidgets.QDoubleSpinBox(Detrend)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox, 6, 8, 1, 1)
    ...
    def retranslateUi(self, Detrend):
        ...
        self.checkBox.setText(_translate("Detrend", "bin data [d]"))
