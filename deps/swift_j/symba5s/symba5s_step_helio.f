...
c Last revision: 7/18/06 MHL
      ...
      subroutine symba5s_step_helio(i1st,nbod,nbodm,mass,j2rp2,
     &     j4rp4,xh,yh,zh,vxh,vyh,vzh,dt,preconst,aref,sx,sy,sz)
...
c     Evolve spin axis due to torque from other planets for a half dt
      call spin_planets(nbod,nbodm,mass,xh,yh,zh,preconst,aref,sx,sy,sz,
     &     dth)
